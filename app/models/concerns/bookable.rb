module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      study_group.bookings.end_during(start_time, end_time),
      study_group.bookings.start_during(start_time, end_time),
      study_group.bookings.happening_during(start_time, end_time),
      study_group.bookings.enveloping(start_time, end_time),
      study_group.bookings.identical(start_time, end_time)
    ].flatten
